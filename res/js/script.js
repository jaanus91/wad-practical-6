$(function () {
    ...
    $('.add-to-cart').click(function (event) {
        ...
        if (index > -1) {
            ...
            //Remove id from cart.selected array (kui see juba seal on, siis eemalda)
    ...
    function refreshAmount() {
        //Set text value of a span element, that is inside element with "cart-container" class to number of selected items
    ...
    function init() {
        ...
        for (let i = 0; i < item.thumbnails.length; i++) {
            ...
            //Append newly create image to an element with class "thumbnails" that is inside of an element with id
            //"item-container"
            $("#item-container .thumbnails").append(img)
        }

        //Loop through array of item
        for (let i = 0; i < items.length; i++) {
            ...
            //Append li tag to ul element inside an element with "suggested-container" class
